...
class Expositor
{
    ...
    public static function getExpositores() 
		{
			...
			$obj_expositor->executeQuery("select * from EXPOSITOR_FRANCES"); 
	...
	{	
		...
		{
			$obj_expositor=new sQuery();
			$result=$obj_expositor->executeQuery("select * from EXPOSITOR_FRANCES where dni = '$nro'"); // ejecuta la consulta para traer al evento
	...
	{		
				$obj_expositor=new sQuery();
				$query="update EXPOSITOR_FRANCES set dni = '$this->dniAux', institucion='$this->institucion', cargo='$this->cargo',
	...
	{		
			...
			$obj_expositor=new sQuery();
			$query="insert into EXPOSITOR_FRANCES(dni, institucion, cargo, biografia)values
	...
	{
			$obj_expositor=new sQuery();
			$query="delete from EXPOSITOR_FRANCES where dni='$this->dni'";
