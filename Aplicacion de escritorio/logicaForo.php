...
include_once ("claseForo.php");// incluyo las clases a ser usadas
$action='index';
...
switch ($action)
{
    ...
    case 'newForo':
        ...
        $view->contentTemplate="ventanaForo.php"; // seteo el template que se va a mostrar
        break;
    case 'editForo':
...
{include_once ('layoutForos.php');} // el layout incluye el template adentro
