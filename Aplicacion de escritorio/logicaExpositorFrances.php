...
include_once ("claseExpositorFrances.php");// incluyo las clases a ser usadas
$action='index';
...
switch ($action)
{
    ...
    case 'newExpositor':
        ...
        $view->contentTemplate="ventanaExpositorFrances.php"; // seteo el template que se va a mostrar
        break;
    case 'editExpositor':
...
{include_once ('layoutExpositoresFrances.php');} // el layout incluye el template adentro
