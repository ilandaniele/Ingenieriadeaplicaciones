...
include_once ("claseCiudadFrances.php");// incluyo las clases a ser usadas
$action='index';
...
{
    case 'index':
        $view->ciudad=CiudadFrances::getCiudad(); // tree todos los eventos
        $view->contentTemplate="tablaCiudad.php"; // seteo el template que se va a mostrar
        break;
    case 'refreshGrid':
        $view->disableLayout=true; // no usa el layout
        $view->ciudad=CiudadFrances::getCiudad();
        $view->contentTemplate="tablaCiudad.php"; // seteo el template que se va a mostrar
        break;
    case 'saveCiudad':
        ...
        $ciudad=new CiudadFrances($cod_postal);
        ...
        break;
    case 'newCiudad':
        $view->ciudad=new CiudadFrances();
        $view->label='Nueva Ciudad';
        $view->disableLayout=true;
        $view->contentTemplate="ventanaCiudadFrances.php"; // seteo el template que se va a mostrar
        break;
    case 'editCiudad':
		$Editcod_postal=intval($_POST['cod_postal']);
        $view->label='Editar Ciudad';
        $view->ciudad=new CiudadFrances($Editcod_postal);
        $view->disableLayout=true;
        $view->contentTemplate="ventanaCiudadFrances.php"; // seteo el template que se va a mostrar
        break;
    case 'deleteCiudad':
...
{include_once ('layoutCiudadFrances.php');} // el layout incluye el template adentro
