...
include_once ("claseEventoSocialIngles.php");// incluyo las clases a ser usadas
$action='index';
...
switch ($action)
{
    ...
    case 'newEvento':
        ...
        $view->contentTemplate="ventanaEventoSocialIngles.php"; // seteo el template que se va a mostrar
        break;
    case 'editEvento':
...
{include_once ('layoutEventosSocialesIngles.php');} // el layout incluye el template adentro
