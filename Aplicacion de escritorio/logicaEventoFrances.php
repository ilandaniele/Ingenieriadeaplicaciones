...
include_once ("claseEventoFrances.php");// incluyo las clases a ser usadas
$action='index';
...
switch ($action)
{
    ...
    case 'newEvento':
        ...
        $view->contentTemplate="ventanaEventoFrances.php"; // seteo el template que se va a mostrar
        break;
    case 'editEvento':
...
{include_once ('layoutEventosFrances.php');} // el layout incluye el template adentro
