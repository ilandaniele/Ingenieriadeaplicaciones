...
class Evento
{
    ...
    public static function getEventos() 
		{
			...
			$obj_evento->executeQuery("select * from EVENTOSOCIAL_INGLES"); // ejecuta la consulta para traer a los eventos
	...
	//hay que cambiarle el atributo clave al evento, y en vez de ponerle el nombre, ponerle el id, y vuelvo a poner el atributo hidden en ventanaEvento, que es el id
		...
		{
			$obj_evento=new sQuery();
			$result=$obj_evento->executeQuery("select * from EVENTOSOCIAL_INGLES where id = '$nro'"); // ejecuta la consulta para traer al evento
	...
	{		
				$obj_evento=new sQuery();
				$query="update EVENTOSOCIAL_INGLES set id = '$this->idAux', nombre='$this->nombre', interes='$this->interes' where id = '$this->id'";
	...
	{		
			...
			$obj_evento=new sQuery();
			$query="insert into EVENTOSOCIAL_INGLES(id, nombre, interes)values
	...
	{
			$obj_evento=new sQuery();
			$query="delete from EVENTOSOCIAL_INGLES where id='$this->id'";
