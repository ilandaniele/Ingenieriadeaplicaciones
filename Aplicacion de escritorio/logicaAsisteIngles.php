...
include_once ("claseAsisteIngles.php");// incluyo las clases a ser usadas
$action='index';
...
switch ($action)
{
    ...
    case 'newAsiste':
        ...
        $view->contentTemplate="ventanaAsisteIngles.php"; // seteo el template que se va a mostrar
        break;
    case 'editAsiste':
...
{include_once ('layoutAsisteIngles.php');} // el layout incluye el template adentro
