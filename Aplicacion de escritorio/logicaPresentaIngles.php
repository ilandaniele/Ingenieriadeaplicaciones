...
include_once ("clasePresentaIngles.php");// incluyo las clases a ser usadas
$action='index';
...
switch ($action)
{
    ...
    case 'newPresenta':
        ...
        $view->contentTemplate="ventanaPresentaIngles.php"; // seteo el template que se va a mostrar
        break;
    case 'editPresenta':
...
{include_once ('layoutPresentaIngles.php');} // el layout incluye el template adentro
