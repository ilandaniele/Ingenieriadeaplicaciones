...
include_once ("claseExpositor.php");// incluyo las clases a ser usadas
$action='index';
...
switch ($action)
{
    ...
    case 'newExpositor':
        ...
        $view->contentTemplate="ventanaExpositor.php"; // seteo el template que se va a mostrar
        break;
    case 'editExpositor':
...
{include_once ('layoutExpositores.php');} // el layout incluye el template adentro
