...
$(document).ready(function(){ //cuando el html fue cargado iniciar
    ...
    $(document).on('click','.edit',function(){
        ...
        $('#popupbox').load('logicaExpositorFrances.php', params,function(){
            $('#block').show();
            $('#popupbox').show();
        })
    ...
    $(document).on('click','.delete',function(){
        ...
        $('#popupbox').load('logicaExpositorFrances.php', params,function(){
            $('#content').load('logicaExpositorFrances.php',{action:"refreshGrid"});
        })
    ...
    $(document).on('submit','#expositor',function(){ //cambio agregado, cuando en el document haya un submit en algun elemento con identificador 'evento'
        ...
        $.post('logicaExpositorFrances.php',params,function(){
            $('#block').hide();
            $('#popupbox').hide();
            $('#content').load('logicaExpositorFrances.php',{action:"refreshGrid"});
        })
