...
$(document).ready(function(){ //cuando el html fue cargado iniciar
    ...
    $(document).on('click','.edit',function(){
        ...
        $('#popupbox').load('logicaPresentaIngles.php', params,function(){
            $('#block').show();
            $('#popupbox').show();
        })
    ...
    $(document).on('click','.delete',function(){
        ...
        $('#popupbox').load('logicaPresentaIngles.php', params,function(){
            $('#content').load('logicaPresentaIngles.php',{action:"refreshGrid"});
        })
    ...
    $(document).on('submit','#presenta',function(){ 
        ...
        $.post('logicaPresentaIngles.php',params,function(){
            $('#block').hide();
            $('#popupbox').hide();
            $('#content').load('logicaPresentaIngles.php',{action:"refreshGrid"});
        })
