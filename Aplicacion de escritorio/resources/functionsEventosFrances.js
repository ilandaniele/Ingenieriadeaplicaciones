...
$(document).ready(function(){ //cuando el html fue cargado iniciar
    ...
    $(document).on('click','.edit',function(){
        ...
        $('#popupbox').load('logicaEventoFrances.php', params,function(){
            $('#block').show();
            $('#popupbox').show();
        })
    ...
    $(document).on('click','.delete',function(){
        ...
        $('#popupbox').load('logicaEventoFrances.php', params,function(){
            $('#content').load('logicaEventoFrances.php',{action:"refreshGrid"});
        })
    ...
    $(document).on('submit','#evento',function(){ //cambio agregado, cuando en el document haya un submit en algun elemento con identificador 'evento'
        ...
        $.post('logicaEventoFrances.php',params,function(){
            $('#block').hide();
            $('#popupbox').hide();
            $('#content').load('logicaEventoFrances.php',{action:"refreshGrid"});
        })
