...
$(document).ready(function(){ //cuando el html fue cargado iniciar
    ...
    $(document).on('click','.edit',function(){
        ...
        $('#popupbox').load('logicaAsisteFrances.php', params,function(){
            $('#block').show();
            $('#popupbox').show();
        })
    ...
    $(document).on('click','.delete',function(){
        ...
        $('#popupbox').load('logicaAsisteFrances.php', params,function(){
            $('#content').load('logicaAsisteFrances.php',{action:"refreshGrid"});
        })
    ...
    $(document).on('submit','#asiste',function(){ 
        ...
        $.post('logicaAsisteFrances.php',params,function(){
            $('#block').hide();
            $('#popupbox').hide();
            $('#content').load('logicaAsisteFrances.php',{action:"refreshGrid"});
        })
