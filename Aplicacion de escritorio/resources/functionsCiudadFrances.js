...
$(document).ready(function(){ //cuando el html fue cargado iniciar
    ...
    $(document).on('click','.edit',function(){
        ...
        $('#popupbox').load('logicaCiudadFrances.php', params,function(){
            $('#block').show();
            $('#popupbox').show();
        })
    ...
    $(document).on('click','.delete',function(){
        ...
        $('#popupbox').load('logicaCiudadFrances.php', params,function(){
            $('#content').load('logicaCiudadFrances.php',{action:"refreshGrid"});
        })
    ...
    $(document).on('submit','#ciudad',function(){ //cambio agregado, cuando en el document haya un submit en algun elemento con identificador 'evento'
        ...
        $.post('logicaCiudadFrances.php',params,function(){
            $('#block').hide();
            $('#popupbox').hide();
            $('#content').load('logicaCiudadFrances.php',{action:"refreshGrid"});
        })
