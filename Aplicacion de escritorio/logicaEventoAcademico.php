...
include_once ("claseEventoAcademico.php");// incluyo las clases a ser usadas
$action='index';
...
switch ($action)
{
    ...
    case 'newEvento':
        ...
        $view->contentTemplate="ventanaEventoAcademico.php"; // seteo el template que se va a mostrar
        break;
    case 'editEvento':
...
{include_once ('layoutEventosAcademicos.php');} // el layout incluye el template adentro
