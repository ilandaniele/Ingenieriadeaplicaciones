...
include_once ("claseEventoSocialFrances.php");// incluyo las clases a ser usadas
$action='index';
...
switch ($action)
{
    ...
    case 'newEvento':
        ...
        $view->contentTemplate="ventanaEventoSocialFrances.php"; // seteo el template que se va a mostrar
        break;
    case 'editEvento':
...
{include_once ('layoutEventosSocialesFrances.php');} // el layout incluye el template adentro
