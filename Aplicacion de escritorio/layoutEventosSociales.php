...
<html lang="en">
  <head>
    ...
    <script type="text/javascript" src="resources/functionsEventosSociales.js"></script>
      ...
      <div class="row">
        <nav class="col-sm-3 col-md-2 d-none d-sm-block bg-light sidebar">
          <ul class="nav nav-pills flex-column">
			...
			<li class="nav-item">
              <a class="nav-link active" href="logicaEventoSocial.php">Eventos sociales en español<span class="sr-only">(current)</span></a>
            </li>
			<li class="nav-item">
