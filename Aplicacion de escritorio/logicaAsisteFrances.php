...
include_once ("claseAsisteFrances.php");// incluyo las clases a ser usadas
$action='index';
...
switch ($action)
{
    ...
    case 'newAsiste':
        ...
        $view->contentTemplate="ventanaAsisteFrances.php"; // seteo el template que se va a mostrar
        break;
    case 'editAsiste':
...
{include_once ('layoutAsisteFrances.php');} // el layout incluye el template adentro
