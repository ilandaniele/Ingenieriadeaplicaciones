...
include_once ("claseEventoAcademicoFrances.php");// incluyo las clases a ser usadas
$action='index';
...
switch ($action)
{
    case 'index':
        ...
        $view->contentTemplate="tablaEventosAcademicos.php"; // seteo el template que se va a mostrar
        break;
    case 'refreshGrid':
    ...
    case 'newEvento':
        ...
        $view->contentTemplate="ventanaEventoAcademicoFrances.php"; // seteo el template que se va a mostrar
        break;
    case 'editEvento':
...
{include_once ('layoutEventosAcademicosFrances.php');} // el layout incluye el template adentro
