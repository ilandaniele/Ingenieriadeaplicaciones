...
include_once ("claseForoFrances.php");// incluyo las clases a ser usadas
$action='index';
...
switch ($action)
{
    ...
    case 'newForo':
        ...
        $view->contentTemplate="ventanaForoFrances.php"; // seteo el template que se va a mostrar
        break;
    case 'editForo':
...
{include_once ('layoutForosFrances.php');} // el layout incluye el template adentro
