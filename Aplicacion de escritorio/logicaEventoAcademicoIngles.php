...
include_once ("claseEventoAcademicoIngles.php");// incluyo las clases a ser usadas
$action='index';
...
switch ($action)
{
    ...
    case 'newEvento':
        ...
        $view->contentTemplate="ventanaEventoAcademicoIngles.php"; // seteo el template que se va a mostrar
        break;
    case 'editEvento':
...
{include_once ('layoutEventosAcademicosIngles.php');} // el layout incluye el template adentro
