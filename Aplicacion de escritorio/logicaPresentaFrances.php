...
include_once ("clasePresentaFrances.php");// incluyo las clases a ser usadas
$action='index';
...
switch ($action)
{
    ...
    case 'newPresenta':
        ...
        $view->contentTemplate="ventanaPresentaFrances.php"; // seteo el template que se va a mostrar
        break;
    case 'editPresenta':
...
{include_once ('layoutPresentaFrances.php');} // el layout incluye el template adentro
